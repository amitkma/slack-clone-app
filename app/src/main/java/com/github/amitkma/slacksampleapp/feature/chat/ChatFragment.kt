...
import com.github.amitkma.slacksampleapp.databinding.FragmentChatBinding
import com.github.amitkma.slacksampleapp.feature.home.HomeViewModel
import com.github.amitkma.slacksampleapp.util.useAdjustResize
...
class ChatFragment : Fragment() {
    ...
    private val cid: String by lazy {
        requireArguments().getString("cid") ?: throw IllegalArgumentException("cid argument can't be null")
    }
    ...
    private fun renderState(state: HomeViewModel.State) {
        state.userId?.let {
            headerViewModel.bindView(binding.messageListHeaderView.root, viewLifecycleOwner,
                state.userId
            )
        }
    }
